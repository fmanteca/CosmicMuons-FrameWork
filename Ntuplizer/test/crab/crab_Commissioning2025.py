...
config.General.requestName = 'CosmicsData_2025v1-Ntuples'
...
# Data
config.Data.inputDataset = '/Cosmics/Commissioning2025-PromptReco-v1/AOD'
config.Data.splitting = 'FileBased'
config.Data.unitsPerJob = 1
config.Data.outLFNDirBase = '/store/group/phys_muon/fernanpe/Cosmics2025/'
config.Data.publication = False
config.Data.outputDatasetTag = 'CosmicsData_2025v1_Ntuples'
