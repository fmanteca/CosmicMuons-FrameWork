...
config.General.requestName = 'Cosmics_2022C_10Dec2022_CMSSW_13_2_0_pre1_MiniAOD_3'
...
config.JobType.psetName = 'Cosmics_ReReco_ABCD_PAT.py'
config.JobType.maxMemoryMB = 3000
config.JobType.allowUndistributedCMSSW = True
config.JobType.numCores = 2

# Data
config.Data.inputDataset = '/NoBPTX/Run2022C-10Dec2022-v1/AOD'
...
config.Data.outputDatasetTag = 'Cosmics_2022C_10Dec2022_CMSSW_13_2_0_pre1_MiniAOD_x'
