...
# with command line options: Muon_PromptReco_ABCD --data --eventcontent MINIAOD --datatier MINIAOD --conditions 124X_dataRun3_PromptAnalysis_v1 --step PAT --nThreads 2 --geometry DB:Extended --era Run3 --filein file:raw.root --fileout file:step0.root --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Muon_PromptReco_ABCD nevts:1'),
