...
# with command line options: Muon_ReReco_ABCD --data --eventcontent MINIAOD --datatier MINIAOD --conditions 124X_dataRun3_v11 --step PAT --nThreads 2 --geometry DB:Extended --era Run3 --filein file:raw.root --fileout file:step0.root --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2022B/DoubleMuon/AOD/10Dec2022-v2/40000/0ff3d4d7-c2f3-4efb-9759-c57caf3815b9.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Muon_ReReco_ABCD nevts:1'),
