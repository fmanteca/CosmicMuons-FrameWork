...
# with command line options: Muon_ReReco_E --data --eventcontent MINIAOD --datatier MINIAOD --conditions 124X_dataRun3_v14 --step PAT --nThreads 2 --geometry DB:Extended --era Run3 --filein file:aod.root --fileout file:step0.root --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Muon_ReReco_E nevts:1'),
