...
config.General.requestName = 'Cosmics_2022D_PromptReco_CMSSW_13_2_0_pre1_MiniAOD'
...
config.JobType.psetName = 'Cosmics_PromptReco_ABCD_PAT.py'
config.JobType.maxMemoryMB = 3000
config.JobType.allowUndistributedCMSSW = True
config.JobType.numCores = 2

# Data
config.Data.inputDataset = '/NoBPTX/Run2022D-PromptReco-v1/AOD'
...
config.Data.outputDatasetTag = 'Cosmics_2022D_PromptReco_CMSSW_13_2_0_pre1_MiniAOD'
